...
import styles from "./base-station-energy-storage.module.css"
import { casesData, schema, schemaCard } from "./solution-data.component"
...
export function BaseStationEnergy() {
  // ---------------------------------------------------------------------------
  // variables
  // ---------------------------------------------------------------------------
