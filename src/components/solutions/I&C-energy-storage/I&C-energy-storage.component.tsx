...
import styles from "./I&C-energy-storage.module.css"
...
import { schema, schemaCard } from "../base-station-energy-storage/solution-data.component"

export function ICEnergyStorage() {
  // ---------------------------------------------------------------------------
  // variables
  // ---------------------------------------------------------------------------
